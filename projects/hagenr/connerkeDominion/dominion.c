...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    switch( card )
    {
        ...
        case steward:
            return steward_card(state, choice1, choice2, choice3, currentPlayer, handPos);
        ...
        case embargo:
            return embargo_card(state, choice1, currentPlayer, handPos);
...
int steward_card(struct gameState *state, int choice1, int choice2, int choice3, int currentPlayer, int handPos)
{
    if (choice1 == 1)
    {
        //+2 cards
...
int embargo_card(struct gameState *state, int choice1, int currentPlayer, int handPos)
{
    //+2 Coins
    state->coins = state->coins + 2;
